...
public class Bibit extends Produk {
    ...
    static final String produk = "Bibit";
    ...
    public void addMessage() {
        System.out.println("\n" + Bibit.produk + " berhasil ditambahkan!");
    }

    @Override
    public void updateMessage() {
        System.out.println("\nRincian " + Bibit.produk + " berhasil diubah!");
    }

    @Override
    public void deleteMessage(String pilihan) {
        if (pilihan.equals("1")) {
            System.out.println("\n" + Bibit.produk + " berhasil dihapus!");
            return;
        }
        System.out.println("\n" + Bibit.produk + " gagal dihapus.");
    }
